...
*******************************************************************************************************
Есть два решения. Один установить handler для всех нитей - Thread.setDefaultUncaughtExceptionHandler().
Или для каждой нити свой handler - setUncaughtExceptionHandler(). Например так:
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        threadA.start();
        threadB.start();
        Thread.setDefaultUncaughtExceptionHandler(handler); // или так!!!
    ...
    public static class TestedThread extends Thread {
        public TestedThread(UncaughtExceptionHandler handler) {
            //setDefaultUncaughtExceptionHandler(handler); // изменил здесь
            start();
        }
