...
public class Solution {
    ...
    public static class MarkTwainBook extends Book
    {
        ...
        public MarkTwainBook(String name)  // Автор передается через суперкласс
        {
            super("Mark Twain");
            this.name = name;
        }
        public MarkTwainBook getBook() // расширить тип возвращаемого результата - с Book до MarkTwainBook
        {
            return this;
        }
    ...
    public static class AgathaChristieBook extends Book
    {
        ...
        {
            super("Agatha Christie"); // Автор передается через суперкласс
            this.name = name;
        }
        public AgathaChristieBook getBook() // расширить тип возвращаемого результата - с Book до AgathaChristieBook
        {
            return this;
        }
        public String getName()
    ...
    public abstract static class Book {
        ...
        private String getOutputByBookType() {
            ...
            switch (author)
            {
                case ("Agatha Christie") : output = agathaChristieOutput; break;
                case ("Mark Twain") : output = markTwainOutput; break;
            }
            return output;
        }
