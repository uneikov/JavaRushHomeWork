...
public class Solution {
    ...
    public static interface Alive { // живой если содержит кости
        Object containsBones();
    }

    public static class BodyPart implements Alive { // части тела
        private String name;
    ...
    public static class Finger extends BodyPart { // палец
        ...
        public Object containsBones() {    // исправить метод и всю связанную с ним логику
            return "Yes".equals(super.containsBones()) && !isFoot ? "Yes" : "No";
        }
    }
    public static void main(String[] args)
    {
        printlnFingers();   // высти пальцы
        printlnBodyParts(); // вывести части тела
        printlnAlives();    // вывести живые <>
    }
