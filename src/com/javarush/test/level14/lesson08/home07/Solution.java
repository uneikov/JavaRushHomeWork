...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        for (Apartament apt : apartaments) {
            ...
            if (apt.getClass().getSimpleName().equals("Apt1Room")) Apt1Room.clean1Room();
            if (apt.getClass().getSimpleName().equals("Apt2Room")) Apt2Room.clean2Rooms();
            if (apt.getClass().getSimpleName().equals("Apt3Room")) Apt3Room.clean3Rooms();
        }
    }
