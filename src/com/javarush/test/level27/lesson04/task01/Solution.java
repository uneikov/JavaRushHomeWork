...
public class Solution {
    ...
    public synchronized void sout(Solution solution) { // add synchronized here
        System.out.format("111:  %s: %s %n", this.field, solution.getField());
        solution.sout2(this); // this already catched
    }

    public synchronized void sout2(Solution solution) { // add synchronized here
