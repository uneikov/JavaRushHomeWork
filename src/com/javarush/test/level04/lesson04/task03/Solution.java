...
public class Solution
{
    ...
    public static void checkInterval(int a){
        if(a>=50) {if(a<=100) System.out.println("Число " + a + " содержится в интервале.");}
        if(a<50) System.out.println("Число "+ a +" не содержится в интервале.");
        else if(a>100) System.out.println("Число "+ a +" не содержится в интервале.");
    }
}