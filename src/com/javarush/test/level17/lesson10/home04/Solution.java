...
public class Solution {
    ...
    protected synchronized void method1(String param1) { // добавлено мной
    ...
    synchronized double method3() { // добавлено мной
    ...
    private synchronized void method4() {
        sb.append(1).append(1).append(1).append(1); // добавлено мной
    }
    ...
    synchronized public String method6(int param2) { // добавлено мной
